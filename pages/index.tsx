...
export default function Home() {
  return (
    <>
      <Head>
        <title>How Does HTX Instant Pay Service Work? | HTX Blog</title>
      ...
      <main className="font-sans space-x-6">
        ...
        <div className="hidden text-3xl w-32 h-4 my-4 font-semibold md:flex"></div>
          <div className="md:flex-auto w-[100%] md:w-72 overflow-hidden"> 
            <div className="text-lg text-left md:text-center mt-4 mb-1 font-semibold md:flex">What does HTX Instant Pay mean?<br/></div>
            ...
            <br/>     
            <i>Learn how the escrow service works on HTX Instant Pay and how it safeguards seller and buyer funds.</i>
            <Image className='mt-16 pr-3' src={"/images/htx.png"} alt="logo" width={792} height={445.5}/>
            <div className="mt-6 pr-6 space-y-6">
              <p>An escrow service is an arrangement in which a trusted third party handles the exchange of goods or assets between the transacting parties, ensuring safety and fair trading. HTX P2P is a peer-to-peer trading market where you can safely trade crypto in exchange for your local currency. HTX P2P&apos;s escrow service safeguards every transaction, giving traders peace of mind.</p>
              <p>Once the buyer places an order, the seller&apos;s cryptocurrency will automatically be transferred from the seller&apos;s wallet to the temporary deposit with HTX escrow. The cryptocurrencies will be held in the deposit guarantee until the transaction is successfully completed by both parties.</p>
            </div>
            <div className="mt-10 space-y-6 pr-4">
              <h1 className="text-2xl font-bold">How Does the HTX Instant Pay Service Work?</h1>
              <h1 className="text-md font-bold">Step 1: Place your order </h1>
              <p className='mt-6'>Place an order to buy or sell cryptocurrency. The crypto will be held by HTX P2P temporarily until the operation is successfully completed.</p>
              <h1 className="text-md font-bold">Step 2: Start a Conversation</h1>
              <p className="mt-6">Start a conversation with the seller or buyer. When you are trading with a counterpart that you do not know, we recommend that you use the chat to communicate with him/her. The seller should always be notified about HTX Escrow rules and regulations.</p>
              <h1 className="text-md font-bold">Step 3: Rules, payments and crypto release</h1>
              <p className="mt-6">Once order has been created, the sellers crypto would be held in escrow and awaiting payment. The buyer is required to make payment using HTX escrow, immediately payment has been made and reciept generated, the funds would be held in escrow and awaiting seller to release crypto, the seller is required to release crypto for immidiate processing of fiat payment into the bank account or any payment method provided by the seller.</p>
              ...
              <p className="mt-6">In these cases you need to contact the HTX Escrow pay by email, click on the <a href="mailto:escrowHTXpaycommunity@gmail.com" className="text-HTX">button</a> to contact support.</p>
            </div>
  
            <div className="mt-10 space-y-6 pr-4">
              <h1 className="text-2xl font-bold">How Does the HTX P2P Escrow Service Help Crypto Sellers?</h1>
              <p className='mt-6'>If the cryptocurrency buyer did not make the payment, HTX P2P&apos;s escrow service will return the cryptocurrency to the seller and the Buyer&apos;s money will be returned after 30 working days. This is why we recommend the buyer to always inform the seller about the HTX escrow pay rules and regulations</p>
            </div>

            <div className="my-10 space-y-6 pr-4">
              <h1 className="text-2xl font-bold">How Does the HTX P2P Escrow Service Help Buyers?</h1>
            ...
            <div className="my-10 space-y-6 pr-4">
              <h1 className="text-2xl font-bold">Frequently Asked Questions About the HTX P2P Escrow Service</h1>
            ...
            <div className="pr-4 mb-10">
              <span className="font-bold">Disclaimer: </span><i>Your use of HTX P2P services and all information and other content (including that of third parties) included in or accessible from HTX P2P services is at your sole risk. Our only responsibility is to handle crypto transactions. All payments are final upon completion unless otherwise required by law. The HTX P2P platform has neither the right nor obligation to resolve any disputes arising from a completed payment. Neither the HTX P2P platform nor its merchants shall be responsible for any loss after a completed payment.</i>
            </div>
